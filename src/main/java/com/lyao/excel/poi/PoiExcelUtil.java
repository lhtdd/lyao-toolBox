...
public class PoiExcelUtil {
    ...
    public static void writeDataToTemplateOutputStream(File excelTemplate, List<List<Object>> data, OutputStream outputStream) throws IOException {
        Workbook book = PoiExcelUtil.getWorkbookFromExcel(excelTemplate);
        PoiExcelUtil.writeDataToWorkbook(null, data, book, 0);
        PoiExcelUtil.writeWorkbookToOutputStream(book, outputStream);
    }
